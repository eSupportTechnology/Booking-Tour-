            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="frontend/assets/img/hero/hero_bg_1_1.jpg">
                        </div>
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="frontend/assets/img/hero/hero_bg_1_2.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style1">
                                <span class="sub-title style1" data-ani="slideinup" data-ani-delay="0.2s">Get unforgetable pleasure with us</span>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="frontend/assets/img/hero/hero_bg_1_3.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style1">
                                <span class="sub-title style1" data-ani="slideinup" data-ani-delay="0.2s">Get unforgetable pleasure with us</span>
                ...
                <div class="input-wrap">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="form-btn col-md-12 col-lg-auto">
                            <button class="th-btn"><img src="frontend/assets/img/icon/search.svg" alt="">Search</button>
                        </div>
                    </div>
...
<!--==============================Category Area  ==============================-->
    ...
    <section class="category-area bg-top-center" data-bg-src="frontend/assets/img/bg/category_bg_1.png">
            ...
            <div class="swiper categorySlider" id="categorySlide">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="category-card single">
                            <div class="box-img global-img">
                                <img src="frontend/assets/img/category/category_1_1.jpg" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single">
                            <div class="box-img global-img">
                                <img src="frontend/assets/img/category/category_1_2.jpg" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single">
                            <div class="box-img global-img">
                                <img src="frontend/assets/img/category/category_1_3.jpg" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single">
                            <div class="box-img global-img">
                                <img src="frontend/assets/img/category/category_1_4.jpg" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single">
                            <div class="box-img global-img">
                                <img src="frontend/assets/img/category/category_1_5.jpg" alt="Image">
                            </div>
...
<!--============================== Service Area   ==============================-->
    ...
    <div class="gallery-area ">
            ...
            <div class="row gy-10 gx-10 justify-content-center align-items-center">
                <div class="col-md-6 col-lg-2">
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_1.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_1.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-2">
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_2.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_2.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_3.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_3.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_4.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_4.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_5.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_5.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_6.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_6.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
                    <div class="gallery-card">
                        <div class="box-img global-img">
                            <a href="frontend/assets/img/gallery/gallery_1_7.jpg" class="popup-image">
                                <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                <img src="frontend/assets/img/gallery/gallery_1_7.jpg" alt="gallery image">
                            </a>
                        </div>
                    </div>
        ...
        <div class="shape-mockup  d-none d-xl-block" data-top="-25%" data-left="0%">
            <img src="frontend/assets/img/shape/line.png" alt="shape">
        </div>
        <div class="shape-mockup movingX d-none d-xl-block" data-top="30%" data-left="3%">
            <img class="gmovingX" src="frontend/assets/img/shape/shape_4.png" alt="shape">
        </div>
    </div>
    ...
    <div class="counter-area space">
        ...
        <div class="shape-mockup d-none d-xl-block" data-bottom="0%" data-left="3%">
            <img src="frontend/assets/img/shape/shape_6.png" alt="shape">
        </div>
        <div class="shape-mockup jump d-none d-xl-block" data-top="5%" data-right="5%">
            <img src="frontend/assets/img/shape/shape_5.png" alt="shape">
        </div>
    </div> 
    
    
    <!--============================== Team Area   ==============================-->
    <section class="bg-smoke space" data-bg-src="frontend/assets/img/bg/team_bg_1.png">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img">
                                    <img src="frontend/assets/img/team/team_1_1.jpg" alt="Team">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img">
                                    <img src="frontend/assets/img/team/team_1_2.jpg" alt="Team">
                                </div>
                                <div class="team-content">
                                    <div class="media-body">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img">
                                    <img src="frontend/assets/img/team/team_1_4.jpg" alt="Team">
                                </div>
                                <div class="team-content">
                                    <div class="media-body">
    ...
    <section class="testi-area overflow-hidden space" id="testi-sec">
                        ...
                        <div class="swiper-slide">
                            <div class="testi-card">
                                <div class="testi-card_wrapper">
                                    <div class="testi-card_profile">
                                        <div class="testi-card_avater">
                                            <img src="frontend/assets/img/testimonial/testi_1_1.jpg" alt="testimonial">
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="testi-card-quote">
                                    <img src="frontend/assets/img/icon/testi-quote.svg" alt="img">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-card">
                                <div class="testi-card_wrapper">
                                    <div class="testi-card_profile">
                                        <div class="testi-card_avater">
                                            <img src="frontend/assets/img/testimonial/testi_1_2.jpg" alt="testimonial">
                                        </div>
                                        <div class="media-body">
        ...
        <div class="shape-mockup d-none d-xl-block" data-bottom="-2%" data-right="0%">
            <img src="frontend/assets/img/shape/line2.png" alt="shape">
        </div>
        <div class="shape-mockup movingX d-none d-xl-block" data-top="30%" data-left="5%">
            <img src="frontend/assets/img/shape/shape_7.png" alt="shape">
        </div>
    </section>
                    ...
                    <div class="swiper-slide">
                        <div class="brand-box">
                            <a href="">
                                ...
                                <img class="gray" src="frontend/assets/img/brand/brand_1_5.svg" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                ...
                <div class="swiper th-slider has-shadow" id="blogSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                <div class="blog-img global-img">
                                    <img src="frontend/assets/img/blog/blog_1_1.jpg" alt="blog image">
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                <div class="blog-img global-img">
                                    <img src="frontend/assets/img/blog/blog_1_2.jpg" alt="blog image">
                                </div>
                                <div class="blog-box_content">
                                    <div class="blog-meta">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                <div class="blog-img global-img">
                                    <img src="frontend/assets/img/blog/blog_1_3.jpg" alt="blog image">
                                </div>
                                <div class="blog-box_content">
                                    <div class="blog-meta">
